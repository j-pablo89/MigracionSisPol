...
// // Crear la carpeta public/fotos si no existe
...
//     cb(null, fotosDir); // Guardar en /public/fotos
//   },
//   filename: function (req, file, cb) {
//     const timestamp = Date.now();
//     const safeName = file.originalname.replace(/\s+/g, '_'); // reemplaza espacios por _
